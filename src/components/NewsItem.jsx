        ...
        <>
            ...
            <div className="card bg-dark text-light mb-3 my-3 mx-3 py-2 px-2 d-inline-block" style={cardStyle}>
                ...
                <div className="card-body">
                    ...
                    <p className="card-text">{description ? description.slice(0, 90) : "Lawyers alleged that Google tracked browser usage of customers in “Incognito” mode to measure web traffic and sell ads"}</p>
